    ...
    public partial class frmUpdtDelParty : Form
    {
        ...
        private void btnUpdtParty_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    String update = "update MST_party set PartyName='" + txtName.Text + "', PartyGSTNumber='" + txtGST.Text + "', PartyAddress='" + address.Text + "', PartyCity='" + txtCity.Text + "', PartyState='" + txtState.Text + "', PartyStateCode=" + nStateCode.Text + ", tModifiedDate='" + mDate + "' where PartyName='" + cbName.SelectedItem.ToString() + "'";
